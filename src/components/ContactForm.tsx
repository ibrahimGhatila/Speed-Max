...
export default function ContactForm() {
  return (
    <section id="contact" className="relative bg-paper-warm py-20 lg:py-28">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10 grid lg:grid-cols-12 gap-12 lg:gap-16">
        <Reveal className="lg:col-span-7">
          ...
          <h2 className="mt-3 font-display text-[32px] sm:text-[40px] lg:text-[52px] text-ink">
            Brief us on a project.{" "}
            <span className="text-mute">
              We&apos;ll come back within three working days.
            </span>
          </h2>
